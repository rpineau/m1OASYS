...
#define MyAppName "m1OASYS X2 Driver"
...
AppId={{8040B104-FFF7-4E7C-ADBF-DBB96669574A}
AppName={#MyAppName}
...
OutputBaseFilename=m1OASYS_X2_Installer
...
[Files]
Source: "domelist m1OASYS.txt";                     DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion
Source: "domelist m1OASYS.txt";                     DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 m1OASYS.txt"
; 32 bits
Source: "libm1OASYS\Win32\Release\libm1OASYS.dll";  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
; 64 bits
Source: "libm1OASYS\x64\Release\libm1OASYS.dll";    DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
